			...
			.classify-list-right{
				...
				.classify-list-r-box{
					...
					.classify-list-right-title{
						...
						.classify-list-right-list{
							display: flex;
							flex-wrap: wrap;
							background-color: #FFFFFF;
						}
							.classify-list-right-a{
								width: 30%;
								height:240upx;
								display: flex;
							...
							.classify-list-right-img{
								width: 100%;
								height: 160upx;
							}
							.classify-list-right-text{
								font-size: 24upx;
								color: #5a5a5a;
								
							}
							
					.classify-list-r-box:nth-last-child(1){
						margin-bottom: 90upx;
					}
</style>
